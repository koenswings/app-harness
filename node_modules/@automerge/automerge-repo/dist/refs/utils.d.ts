...
import type { Pattern, CursorMarker, RefUrl, Ref, InferRefTypeFromString } from "./types.js";
/**
 ...
 * ```
 */
export declare function cursor(start: number, end?: number): CursorMarker;
/**
 ...
 * ```
 */
export declare function refFromUrl<TValue = unknown>(handle: DocHandle<any>, url: RefUrl): Ref<TValue>;
/**
 ...
 * ```
 */
export declare function refFromString<TDoc, TPath extends string>(docHandle: DocHandle<TDoc>, path: TPath): Ref<InferRefTypeFromString<TDoc, TPath>>;
/**
 ...
 * ```
 */
export declare function findRef<TValue = unknown>(repo: Repo, url: RefUrl): Promise<Ref<TValue>>;
/**
 ...
 * @internal
 */
export declare function matchesPattern(item: any, pattern: Pattern): boolean;

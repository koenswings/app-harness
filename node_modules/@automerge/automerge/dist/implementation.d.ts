...
import type { Automerge, API as WasmAPI, Actor as ActorId, Prop, ObjID, Change, ChangeMetadata, DecodedChange, DiffOptions, Heads, MaterializeValue, JsSyncState, SyncMessage, Span, DecodedSyncMessage, UpdateSpansConfig } from "./wasm_types.js";
export type { ChangeMetadata, PutPatch, DelPatch, DiffOptions, SpliceTextPatch, InsertPatch, IncPatch, Span, SyncMessage, UpdateSpansConfig, } from "./wasm_types.js";
/** @hidden **/
type API = WasmAPI;
 ...
 */
export declare function diffPath(doc: Doc<unknown>, path: Prop[], before: Heads, after: Heads, opts?: DiffOptions): Patch[];
/** @hidden */
 ...
 * @group sync
 */
export declare function initSyncState(options?: {
    readOnly?: boolean;
}): SyncState;
/** @hidden */
 ...
 */
export declare function releaseInfo(): ReleaseInfo;
/**
 * Modify a string
 *
 * @typeParam T - The type of the value contained in the document
